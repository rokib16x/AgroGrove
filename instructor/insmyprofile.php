...
<head>
    ...
    <link rel="stylesheet" href="insmyprofile.css">
</head>
                                    ...
                                    <div class="col-md-6 border-right">
                                        <div class="p-3 py-5">
                                            ...
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-md-12"><label class="labels">Email ID</label><input type="text" class="form-control" placeholder="enter email id" value="<?php echo $row['ins_email']; ?>" disabled required></div>
