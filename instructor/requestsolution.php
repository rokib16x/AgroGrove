...
<head>
    ...
    <title>Requested Solution</title>
                            ...
                            <div class="row">
                                <table class="table table-bordered table-hover table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "SELECT * FROM farmer WHERE Address='$address1' AND solvedstatus = 1";
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="sendsolution.php?tmail=<?php echo $result['f_email'] ?>" class="btn btn-info"><i class="fa fa-comments"></i></a>
                                                </td>
                                            <?php
                                            $cnt++;
                                        }
