...
if (isset($_POST["submit"])) {
    ...
    if ($password == $cpassword) {
        ...
        $sql = "UPDATE instructor SET first_name='$first_name', last_name='$last_name', address='$address', password='$password' WHERE ins_email='{$_SESSION["tempmail"]}'";
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            ?>
                                    ...
                                    <div class="inputBox">
                                        ...
                                        <input type="email" id="email" name="email" placeholder="Email Address" value="<?php echo $row['ins_email']; ?>" disabled required>
                                    </div>
                                    <br>
