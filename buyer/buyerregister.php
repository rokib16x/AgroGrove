...
if (isset($_POST['submit'])) {
    ...
    if ($password == $cpassword) {
        ...
        if (!$result->num_rows > 0) {
            $sql = "INSERT INTO buyer (first_name, last_name, b_email, mobile_no, Address,password)
...
<body>
    <div class="container">
        <form action="" method="POST" class="login-email">
            ...
            <p class="login-register-text">Have an account? <a href="buyerlogin.php">Login Here</a></p>
        </form>
    </div>
</body>
