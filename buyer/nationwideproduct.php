            ...
            <div class="main-body">
                <div class="headtittle">
                    ...
                    <!-- <section id="sections" class="py-4 mb-4">
                        <div class="searchbox">
                            <form action="nationwideproduct.php" method="post">
                        ...
                        <div class="">
                            <div class="row">
                                <table class="table table-bordered table-hover table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql = "SELECT fam.first_name, fam.last_name,fam.mobile_no,fam.Address, fam.p_id, pro.product_id,
                                                pro.product_name, pro.Quantity, pro.Price 
                                                FROM farmer fam
