...
if (isset($_POST["submit"])) {
    ...
    if ($password == $cpassword) {
        ...
        $sql = "UPDATE buyer SET first_name='$first_name', last_name='$last_name', address='$address', password='$password' WHERE b_email='{$_SESSION["tempmail"]}'";
                ...
                <div class="headtittle">
                    <div class="formlevel">
                        <form action="" method="post" enctype="multipart/form-data">
                            <?php
                            $sql = "SELECT * FROM buyer WHERE b_email='{$_SESSION["tempmail"]}'";
                            $result = mysqli_query($conn, $sql);
                            ...
                            ?>
                                    ...
                                    <div class="inputBox">
                                        ...
                                        <input type="email" id="email" name="email" placeholder="Email Address" value="<?php echo $row['b_email']; ?>" disabled required>
                                    </div>
                                    <br>
