                ...
                <div class="headtittle">
                    ...
                    <section id="sections" class="py-4 mb-4">
                        <div>
                            <div class="row">
                                <div class="col-md-2">
                                    <a href="myworker.php" class="btn btn-primary btn-block" style="border-radius:0%;"><i class="fa fa-sign-out"></i> Exit</a>
                                </div>
                            ...
                            <div class="row">
                                <table class="table table-bordered table-hover table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "SELECT * FROM worker WHERE Address='$address1' AND status=0";
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="workersql.php?hire=<?php echo $result['w_email'] ?>" class="btn btn-info"><i class="fa fa-user-plus"></i></a>
                                                </td>
                                            <?php
                                            $cnt++;
                                        }
